...
namespace back_salidaActivos.Models
{
    public class GestorSolicitud
    {
        ...
        ////
        public bool updateSolicitud(int id, lote Lote)
        {
            bool res = false;
            string strConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
            using (SqlConnection conn = new SqlConnection(strConn))
            {
                ...
                cmd.Parameters.AddWithValue("@lote2", Lote.lote2);
                cmd.Parameters.AddWithValue("@orden", Lote.orden);
                cmd.Parameters.AddWithValue("@producto", Lote.producto);
                cmd.Parameters.AddWithValue("@codigo", Lote.codigo);
                cmd.Parameters.AddWithValue("@kg", Lote.kg);
                cmd.Parameters.AddWithValue("@mts", Lote.mts);
                cmd.Parameters.AddWithValue("@almacen", Lote.almacen);
        ...
        public bool addSolicitud(lote Lote)
        {
            bool res = false;
            string strConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
            using (SqlConnection conn = new SqlConnection(strConn))
